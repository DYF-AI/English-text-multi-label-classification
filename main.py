...
def train_model():
    ...
    params =    { "batch_size": 16, "dropout_keep_prob": 0.5, "embedding_dim": len(vocabulary), "evaluate_every": 200, "filter_sizes": "3,4,5",
                  "hidden_unit": 300, "l2_reg_lambda": 0.0, "max_pool_size": 4, "non_static": False, "num_epochs": 128,"num_filters": 32
                }   ## "num_epochs": 1-->128
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            test_batches = Data_preprocess.batch_iter(list(zip(x_test, y_test)), params['batch_size'], 1, shuffle=False)
